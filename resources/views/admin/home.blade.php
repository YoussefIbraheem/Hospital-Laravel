                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
                      <div class="item">
                        <img src="{{asset('admin-assets/images/dashboard/Rectangle.jpg')}}" alt="image">
                      </div>
                      <div class="item">
                        <img src="{{asset('admin-assets/images/dashboard/Img_5.jpg')}}" alt="image">
                      </div>
                      <div class="item">
                        <img src="{{asset('admin-assets/images/dashboard/img_6.jpg')}}" alt="image">
                      </div>
                    </div>
